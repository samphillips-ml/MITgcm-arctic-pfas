...
**experiment/** contains the MITgcm run directory — everything needed to run the simulation once transferred to HPC. Experiments that I wish to save will be in a parent directory.
